...
type CacheTypes = 'input' | 'main' | 'monoGroup' | 'stereoGroup' | 'monoAux' | 'stereoAux' | 'monoMatrix'
    | 'stereoMatrix' | 'monoFXSend' | 'stereoFXSend' | 'FXReturn' | 'group' | 'dca';
...
function buildMuteFeedback(self: AvantisInstance, choice: Choice, name: string, type: CacheTypes): CompanionFeedbackDefinition {
